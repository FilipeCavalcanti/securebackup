...
void setup() {
  ...
  Serial.println("Formato dos dados");
  Serial3.println("DiaMesAno;HoraMinutosSegundos;Latitude;Longitude;Velocidade;Altitude;Satelites;GyroX;GyroY;GyroZ;AcelerometroX;AcelerometroY;AcelerometroZ");
  Serial3.println("DiaMesAno;HoraMinutosSegundos;Latitude;Longitude;Velocidade;Altitude;Satelites;GyroX;GyroY;GyroZ;AcelerometroX;AcelerometroY;AcelerometroZ");
  delay(300);
	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++
          ...
          Serial3.println(" OK!");
					...
					File dataFile = SD.open("datalogfsae2.txt", FILE_WRITE);
